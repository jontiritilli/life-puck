...
// Compatibility macro aliases for .cpp usage
#define EXAMPLE_LCD_H_RES EXAMPLE_LCD_WIDTH
#define EXAMPLE_LCD_V_RES EXAMPLE_LCD_HEIGHT
#define EXAMPLE_LCD_BIT_PER_PIXEL EXAMPLE_LCD_COLOR_BITS
#define EXAMPLE_LCD_PIN_NUM_CS ESP_PANEL_LCD_SPI_IO_CS
#define LCD_HOST ESP_PANEL_HOST_SPI_ID_DEFAULT
