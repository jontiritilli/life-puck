...
// I2C settings
#define I2C_Touch_SDA_IO GPIO_NUM_1     /*!< GPIO number used for I2C master data  */
#define I2C_Touch_SCL_IO GPIO_NUM_3     /*!< GPIO number used for I2C master clock */
#define I2C_Touch_INT_IO GPIO_NUM_4     /*!< GPIO number used for I2C master data  */
#define I2C_Touch_RST_IO GPIO_NUM_NC    /*!< GPIO number used for I2C master clock */
#define I2C_Touch_MASTER_NUM GPIO_NUM_1 /*!< I2C master i2c port number, the number of i2c peripheral interfaces available will depend on the chip */
